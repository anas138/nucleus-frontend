<template>
  <div>
    <div class="my-6 col-12">
      <TroubleTicketElSteps :key="refreshKey" />
    </div>
    <div class="card">
      <div class="card-body row p-5">
        ...
        >
          <TroubleTicketViewForm
            ...
            :is-editable="true"
            @refresh-trouble-ticket="incrementRefresh"
          />
        </div>
        <div
          class="col-lg-4 overflow-auto h-1000px"
    ...
    <div class="card">
      <div class="card-body row p-5">
        <div class="col-lg-6">
          <TroubleTicketActivityLog :key="refreshKey" />
        </div>
        <div class="col-lg-6">
          <CommentsTimeline :key="refreshKey" :show-comment-box="false" />
        </div>
      </div>
    </div>
  </div>
