  ...
  <div class="table-responsive">
    <table
      :class="[
        ...
        tableBordered && data.length
          ? 'table-row-bordered gx-4'
          : 'table-row-dashed',
        tableHover && 'table-hover',
      ]"
      class="table align-middle fs-6 gy-2 dataTable no-footer text-nowrap table-strip"
    >
      <TableHeadRow
        ...
        :header="header"
        :header-capitalize="headerCapitalize"
