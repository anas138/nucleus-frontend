...
import NokiaTXNAlarmDetail from "@/components/nokia-txn-components/NokiaTXNAlarmDetail.vue";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const fetchData = async () => {
      ...
      const res = await NokiaTXNAlarmService.getAllAlarms(
    ...
    onUnmounted(() => {
      if (props.socketToggled) {
        SocketIoService.socket.off(
          AppConstants.SOCKET_EVENTS.NOKIA_TXN_ALARMS,
          eventListenerCB
        );
      }
    });
